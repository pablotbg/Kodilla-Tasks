...
class TrelloClientTest {
    ...
    void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        when(trelloConfig.getTrelloUserName()).thenReturn("pawepraga");

        TrelloBoardDto[] trelloBoards = new TrelloBoardDto[1];
        trelloBoards[0] = new TrelloBoardDto("test_name", "test_id", new ArrayList<>());

        URI uri = new URI("http://test.com/members/pawepraga/boards?key=test&token=test&fields=name,id&lists=all");
